  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        // toast.success("Your Tour sccessfully Booked");
        console.log(res);
      }
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center space-x-3">
                    <button
                      ...
                      className="w-8 h-8 rounded-full border border-gray-300 hover:bg-red-400 flex items-center justify-center disabled:opacity-50"
                    >
                      -
                    </button>
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full border border-gray-300 hover:bg-green-300 flex items-center justify-center disabled:opacity-50"
                    >
                      +
                    </button>
                  </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex justify-between text-lg font-bold">
                    ...
                    <span><span className="text-2xl">৳</span>{totalAmount}</span>
                  </div>
                </div>
